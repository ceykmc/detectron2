    ...
    def __init__(self,
        ...
        for ii in range(stack):
            self.stack_bifpn_convs.append(
                BiFPNModule(channels=out_channels,
    ...
    def forward(self, inputs):
        ...
        pathtd[levels - 1] = \
            (w1[0, levels - 1] * pathtd[levels - 1] + \
                w1[1, levels - 1] * F.max_pool2d(pathtd[levels - 2], kernel_size=2)) / (w1[0, levels - 1] + w1[1, levels - 1] + self.eps)
